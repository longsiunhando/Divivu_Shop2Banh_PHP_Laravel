        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <a class="breadcrumb-item text-dark" href="#">Giao dịch</a>
                    <span class="breadcrumb-item active">Thông tin thanh toán</span>
                </nav>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label>Họ</label>
                            <input class="form-control" type="text" placeholder="DepTry">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="text" placeholder="+84 981 076 110">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Xã/Phường/Thị trấn</label>
                            <input class="form-control" type="text" placeholder="LK City">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Huyện/Thị xã</label>
                            <input class="form-control" type="text" placeholder="KhoaiChau">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Tỉnh/Thành phố</label>
                            <select class="custom-select">
                                <option selected> Hưng Yên</option>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="text" placeholder="70000">
                        </div>
